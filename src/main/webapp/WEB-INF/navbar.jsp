 <nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm">
        ...
        <div class="container collapse" id="navbarToggleExternalContent">
          <a class="navbar-brand fs-2 fw-bold text-white me-5" href="home" style="font-family: 'Bodoni Moda', serif;" ><img class="h-25 d-inline-block w-50" src="images/ABC-sm.png" alt="..." /></a>
      ...
      <% } %>
         <% if((Boolean) session.getAttribute("isLogin") != null) { %>
              <a href="logout" class="btn btn-outline-danger fs-6 bg-light">Logout</a>
              <% } else { %>
